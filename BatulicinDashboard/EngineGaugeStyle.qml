...
CircularGaugeStyle {
    ...
    property string icon: "PropIcon.png"
    ...
    tickmarkLabel:  Text {
        ...
        color: styleData.value >= 3000 ? "#d80808" : "white"
        antialiasing: true
    }
    ...
    Image {
        source: icon
        anchors.bottom: propgaugestyle.verticalCenter
        anchors.bottomMargin: toPixels(0.3)
        anchors.horizontalCenter: propgaugestyle.horizontalCenter
        width: toPixels(0.3)
        height: width
